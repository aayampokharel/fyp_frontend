...
import "package:flutter_dashboard/features/admin/presentation/view/admin.dart";
...
class _AdminLoginPageState extends State<AdminLoginPage> {
      ...
      body: BlocConsumer<AuthenticationBloc, AuthenticationState>(
        listener: (context, state) {
          if (state is AdminAccountVerificationSuccessState) {
            _handleAdminSignInSuccess(
              context,
              state.adminDashboardCountsEntity,
            );
          }
  ...
  void _handleAdminSignInSuccess(
    BuildContext context,
    AdminDashboardCountsEntity dashboardCount,
  ) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => AdminPage(dashboardCounts: dashboardCount),
      ),
    );
  }
}
